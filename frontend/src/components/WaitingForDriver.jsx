...
const WaitingForDriver = ({setWaitingForDriverPanelOpen}) => {
    ...
    return (
        <div>
            <span className="absolute top-2 w-full flex justify-center text-2xl" onClick={() => setWaitingForDriverPanelOpen(false)} ><i className="ri-arrow-down-wide-line"></i></span>
