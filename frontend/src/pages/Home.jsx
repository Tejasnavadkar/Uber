...
const Home = () =>{
 ...
 const data = useUserContext()
   console.log('contextData--',data)
    ...
    return (
        <div>
            <div className=" bg-cover bg-center bg-[url(https://images.unsplash.com/photo-1619059558110-c45be64b73ae?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDUxfHx8ZW58MHx8fHx8)] h-screen bg-red-400 pt-8 flex flex-col justify-between ">
